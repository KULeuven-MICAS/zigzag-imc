...
class Core:
    ...
    def __init__(
        ...
        # TODO: [jiacong] [MODIFY]
        self.memory_level_list_in_order = memory_hierarchy.mem_level_list
        self.memory_level_r_cost = [mem.memory_instance.r_cost for mem in memory_hierarchy.mem_level_list]
        self.memory_level_w_cost = [mem.memory_instance.w_cost for mem in memory_hierarchy.mem_level_list]
        self.memory_level_area = [mem.memory_instance.area for mem in memory_hierarchy.mem_level_list]
        # TODO: [jiacong] [FINISH]
        self.dataflows = (
