...
python main_onnx_opt.py --model zigzag/inputs/examples/workload/mlperf_tiny/deepautoencoder.onnx --accelerator zigzag.inputs.examples.hardware.Dimc --mapping zigzag.inputs.examples.mapping.default_imc
