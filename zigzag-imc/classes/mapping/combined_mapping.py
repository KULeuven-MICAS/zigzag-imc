...
class Mapping:
    ...
    def __init__(self, spatial_mapping: Dict or SpatialMapping, temporal_mapping: Dict or TemporalMapping,
        ...
        if 'I' in self.temporal_mapping.operand_list:
            ...
            dict_tm_vals = {'C':'C', 'K':'K', 'IX_r':'OX', 'IX_ir': 'OX', 'IY_ir' :'OY', 'IY_r':'OY','B':'B', 'G':'G'}
...
if __name__ == "__main__":
    ...
    #     {'W': [[('K', 4)], [('FX', 3), ('OX', 2)], [('FY', 9), ('C', 8), ('OY', 4), ('B', 2)]],
    #      'I': [[('K', 4), ('FX', 3)], [('OX', 2), ('FY', 9)], [('C', 8), ('OY', 4), ('B', 2)]],
    #      'O': [[('K', 4), ('FX', 3)], [('OX', 2), ('FY', 9), ('C', 8)], [('OY', 4), ('B', 2)]]}

    spatial_mapping_dic = {'W': [[], [('C', 4), ('K', 4)], [], []],
                           'I': [[], [('C', 4), ('K', 4)], [], []],
                           'O': [[('C', 4)], [('K', 4)], [], []]}

    temporal_mapping_dic = \
        {'W': [[('OX', 2), ('FX', 3)], [('OY', 2), ('FY', 3)], [('K', 2)]],
         'I': [[('OX', 2), ('FX', 3)], [('OY', 2), ('FY', 3)], [('K', 2)]],
         'O': [[('OX', 2), ('FX', 3)], [('OY', 2), ('FY', 3)], [('K', 2)]]}
